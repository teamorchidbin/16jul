  ...
  const handleMenuAction = (action: string, scheduleId: string) => {
    ...
    switch (action) {
      ...
      case 'delete':
        ...
        break;
      case 'setDefault':
        console.log('Setting as default', scheduleId);
        break;
    }
  };
            ...
            <div className="flex items-start justify-between">
              <div className="flex-1 min-w-0">
                <div className="flex items-center mb-2 space-x-2">
                  ...
                  {schedule.isDefault && (
                    <span className="inline-flex items-center px-2 py-1 bg-muted text-foreground text-xs rounded font-medium">
                      Default
                    </span>
                  )}
                </div>
              ...
              <div className="flex items-center space-x-2 ml-4" onClick={(e) => e.stopPropagation()}>
                <div className="relative">
                  ...
                  {showMoreOptions === schedule.id && (
                    <div className="absolute right-0 top-full mt-1 w-36 bg-popover border border-border rounded-lg shadow-lg animate-scale-in z-10">
                      <div className="py-1">
                        <button
