...
export default function Bookings() {
      ...
      today: [
        {
          ...
          location: { type: 'online', app: 'Google Meet', link: 'https://meet.google.com/abc-def-ghi' },
          status: 'confirmed',
      ...
      tomorrow: [
        {
          ...
          time: '2:00pm - 3:00pm',
          timezone: 'Indian Standard Time',
          location: { type: 'physical', address: '123 Business Street, Tech Park, Bangalore' },
          status: 'confirmed',
      ...
      later: [
        {
          ...
          timezone: 'Indian Standard Time',
          location: { type: 'online', app: 'Zoom', link: 'https://zoom.us/j/123456789' },
          status: 'pending',
      ...
      weekly: [
        {
          ...
          timezone: 'Indian Standard Time',
          location: { type: 'online', app: 'Jitsi', link: 'https://meet.jit.si/weekly-standup' },
          status: 'confirmed',
      ...
      yesterday: [
        {
          ...
          time: '3:00pm - 4:00pm',
          timezone: 'Indian Standard Time',
          location: { type: 'online', app: 'Google Meet', link: 'https://meet.google.com/xyz-abc-def' },
          status: 'completed',
      ...
      thisWeek: [
        {
          ...
          time: '1:00pm - 2:00pm',
          timezone: 'Indian Standard Time',
          location: { type: 'physical', address: '456 Corporate Ave, Business District, Mumbai' },
          status: 'canceled',
  ...
  const renderBookingCard = (booking: any) => {
    ...
    return (
      <div 
        key={booking.id} 
        className="bg-card border border-border rounded-lg p-6 hover:shadow-sm transition-all duration-200 cursor-pointer"
  ...
  return (
    <>
      <div className="min-h-screen bg-background">
        {/* Header */}
        <div className="h-20 border-b border-border bg-background/95 backdrop-blur supports-[backdrop-filter]:bg-background/60 sticky top-0 z-50">
          <div className="h-full px-8 flex items-center justify-between w-full">
            <div className="flex-1">
              ...
              <p className="text-sm text-muted-foreground mt-1">Manage your upcoming and past bookings</p>
            </div>
          </div>
        </div>
