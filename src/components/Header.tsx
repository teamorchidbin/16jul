...
export const Header = ({
  ...
  return <header className="h-20 border-b border-border bg-background/95 backdrop-blur supports-[backdrop-filter]:bg-background/60 sticky top-0 z-50">
      <div className="h-full px-8 flex items-center justify-between w-full">
        {showEventTypesHeader && !eventData && <div className="flex-1">
        ...
        {isBookingsPage && <div className="flex-1">
        ...
        {isAvailabilityPage && <div className="flex-1">
        ...
        {isTeamsPage && <div className="flex-1">
        ...
        {eventData && <div className="flex-1">
        ...
        <div className="flex items-center space-x-4 ml-auto">
          {eventData && <div className="flex items-center space-x-2">
          ...
          <div className="relative" ref={dropdownRef}>
            <button onClick={() => setShowProfileDropdown(!showProfileDropdown)} className="flex items-center space-x-3 px-4 py-2 hover:bg-muted rounded-lg transition-colors w-full">
            ...
            {showProfileDropdown && <div className="absolute right-0 top-full mt-1 w-48 bg-popover border border-border rounded-lg shadow-lg animate-scale-in z-10">
                <div className="py-1">
                  <button onClick={() => {
